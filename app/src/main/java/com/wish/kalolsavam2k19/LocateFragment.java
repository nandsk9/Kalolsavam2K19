...
public class LocateFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        parentHolder = inflater.inflate(R.layout.fragment_locate, container,
                false);
        btMap=parentHolder.findViewById(R.id.btmap);
        btMap.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                //also sent the lat,long to map activity
                //returned by a function
                //Toast.makeText(getActivity().getApplicationContext(),"Hello Javatpoint",Toast.LENGTH_SHORT).show();
                Intent intentToMap = new Intent(getActivity().getApplicationContext(),MapsActivity.class);
